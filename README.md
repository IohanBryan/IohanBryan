...
Me chamo **Iohan Bryan da Silva Fortaleza** e sou natural do Brasil.  
Sou **Técnico em Informática para Internet pelo SENAI**, com formação voltada à tecnologia e análise de dados. Atualmente, atuo com **Análise de Dados**, desenvolvendo projetos práticos com foco em automação, organização e interpretação de informações.

Tenho interesse em transformar dados em insights relevantes, utilizando **Python, SQL, Power BI e Excel**, aplicando análise exploratória, automação de processos e visualização de dados para apoio à tomada de decisão.
